...
LFMusicGenre MusicGenres[MusicGenreCount] = {
	{ L"", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Abstract", IDI_FLD_ELECTRONIC, FALSE, TRUE },
	{ L"Acapella", IDI_FLD_REDCURTAIN, FALSE, TRUE },
	{ L"Acid Jazz", IDI_FLD_JAZZ, FALSE, TRUE },
	{ L"Acid Punk", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Acid", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Acoustic", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Avantgarde", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Ballad", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Baroque", IDI_FLD_CLASSICAL, FALSE, TRUE },
	{ L"Bass", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Beat", IDI_FLD_OLDIES, FALSE, TRUE },
	{ L"Bebob", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Bhangra", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Big Band", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Big Beat", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Black Metal", IDI_FLD_METAL, FALSE, TRUE },
	{ L"Bluegrass", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Blues", IDI_FLD_BLUES, TRUE, TRUE },
	{ L"Bollywood", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Booty Bass", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Breakbeat", IDI_FLD_ELECTRONIC, FALSE, TRUE },
	{ L"Britpop", IDI_FLD_POP, FALSE, TRUE },
	{ L"Cabaret", IDI_FLD_REDCURTAIN, FALSE, TRUE },
	{ L"Celtic", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Christian Gangsta Rap", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Christian Rap", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Christian Rock", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Experimental", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Fast Fusion", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Folk", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Folk-Rock", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Folklore", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Freestyle", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Funk", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Fusion", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"G-Funk", IDI_FLD_HIPHOP, FALSE, TRUE },
	{ L"Game", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Industrial", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Industro-Goth", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Instrumental Pop", IDI_FLD_POP, FALSE, TRUE },
	{ L"Instrumental Rock", IDI_FLD_ROCK, FALSE, TRUE },
	{ L"Instrumental", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"International", IDI_FLD_WORLDMUSIC, FALSE, TRUE },
	{ L"Jam Band", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Leftfield", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Lo-Fi", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Lounge", IDI_FLD_AMBIENT, FALSE, TRUE },
	{ L"Math Rock", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"National Folk", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Native US", IDI_FLD_WORLDMUSIC, FALSE, TRUE },
	{ L"Negerpunk", IDI_FLD_NOTE, FALSE, FALSE },
	...
	{ L"New Wave", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Noise", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Other", IDI_FLD_NOTE, TRUE, TRUE },
	{ L"Podcast", IDI_FLD_SPOKENWORD, FALSE, TRUE },
	{ L"Polka", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Polsk Punk", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Pop", IDI_FLD_POP, TRUE, TRUE },
	{ L"Pop-Folk", IDI_FLD_POP, FALSE, TRUE },
	{ L"Pop-Punk", IDI_FLD_POP, FALSE, TRUE },
	{ L"Porn Groove", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Post-Punk", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Post-Rock", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Power Ballad", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Pranks", IDI_FLD_REDCURTAIN, FALSE, TRUE },
	{ L"Primus", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Progressive Rock", IDI_FLD_ROCK, FALSE, TRUE },
	{ L"PsybientSynthPop", IDI_FLD_POP, FALSE, TRUE },
	{ L"Psychadelic", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Psychedelic Rock", IDI_FLD_ROCK, FALSE, TRUE },
	{ L"Psytrance", IDI_FLD_ELECTRONIC, FALSE, TRUE },
	{ L"Punk Rock", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Punk", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Revival", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Rhythmic Soul", IDI_FLD_SOUL, FALSE, TRUE },
	{ L"Rock & Roll", IDI_FLD_ROCK, FALSE, TRUE },
	...
	{ L"Ska", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Slow Jam", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Slow Rock", IDI_FLD_ROCK, FALSE, TRUE },
	{ L"Sonata", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Soul", IDI_FLD_SOUL, TRUE, TRUE },
	{ L"Sound Clip", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Swing", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Top 100", IDI_FLD_NOTE, FALSE, TRUE },
	{ L"Top 40", IDI_FLD_NOTE, FALSE, TRUE },
	...
	{ L"Variété Française", IDI_FLD_NOTE, FALSE, TRUE },
